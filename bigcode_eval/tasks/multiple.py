...
class GeneralMultiPLE(Task):
    ...
    def __init__(self, language):
        ...
        self.dataset = load_from_disk(f"/mnt/code/users/wangshuai/human_eval/MultiPL-E/data_MultiPL-E/{self.DATASET_NAME}")
    ...
    def process_results(self, generations, references):
        ...
        results = {
            f"pass@{k}": v
            for k, v in zip([1, 3, 5, 8, 10, 12, 15, 100], result)
